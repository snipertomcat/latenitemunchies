...
class ItemmetaBuilderTest extends Illuminate\Foundation\Testing\TestCase
{
    /**
     * The base Builder class (ItemmetaBuilder).
     *
     * @var string
     */
    protected $builderClass = '\App\Models\Builder\ItemmetaBuilder';

    protected $builder;

    protected $subject = '\App\Models\OrderItemmetaCache';
